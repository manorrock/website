# Manorrock Sustainability Initiative: Final Chapter
...
- **Piranha's Successful Transition**: Piranha projects have been moved to the Eclipse Foundation. The website and domain will be formally transferred to Eclipse personnel in the coming weeks, completing this chapter
- **Clear Documentation**: GitHub issues and archival notices were created for all projects
- **Honest Assessment**: We faced the reality that these projects had reached their end
...
- **Piranha Projects**: Have been successfully transferred to the Eclipse Foundation, with the website and domain transfer to Eclipse personnel completing in the coming weeks
- **All Other Manorrock Projects**: Have been moved to the manorrock-attic organization. Given the complete absence of interest, these repositories will be made private on January 1st, 2027, and deleted entirely on January 1st, 2028. This accelerated timeline reflects the brutal reality: if no one stepped forward during the transition period, no one will miss them when they're gone
...
1. **Finding Maintainers Is Hard**: Even with clear documentation, willing support, and active outreach, finding committed maintainers is incredibly difficult
2. **Most Projects End**: The reality is that most open source projects eventually reach their conclusion, and often with little fanfare
3. **Zero Interest Means Zero Value**: Complete silence from the community is a clear signal that these projects no longer serve a need
4. **Don't Preserve What No One Wants**: Keeping unmaintained code accessible indefinitely serves no purpose if no one is using it
5. **The Long Tail Dies**: The vast majority of open source projects fade into obscurity, and that's the natural order of things

## Gratitude

I want to express my sincere gratitude to:

- **Eclipse Foundation**: For providing a path forward for the Piranha projects
- **Project Users**: For using these projects over the years
